	...
	while (continuer)
	 {
		...
		glPushMatrix();
			glTranslated(-0.19, -0.14, -0.02);
			glRotated(45, 1, 0, 0);
			gluDisk(quad1, 0.04, 0.04, 15, 15);
		glPopMatrix();
		glPushMatrix();
			glTranslated(-0.19, -0.34, 0.17);
			glRotated(-30, 1, 0, 0);
			gluCylinder(quad1, 0.04, 0.035, 0.23, 15, 15);
		glPopMatrix();
		glColor3ub(0, 0, 0);
		glPushMatrix();
			glTranslated(-0.19, -0.22, 0.38);
			gluSphere(quad1, 0.05, 15, 15);
		glPopMatrix();
		glPushMatrix();
			glTranslated(-0.19, -0.18, 0.36);
			glRotated(-60, 1, 0, 0);
